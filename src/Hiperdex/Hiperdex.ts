...
const SOURCE_DOMAIN = "https://hiperdex.com/"

export class Hiperdex extends Source {
    constructor(cheerio: CheerioAPI) {
        super(cheerio)
    }

    get version(): string { return '0.1.0' }
    get name(): string { return 'Hiperdex' }
    get description(): string { return 'Adult Manga Source' }
    get author(): string { return 'Hiperdex' }
    get authorWebsite(): string { return '' }
    get icon(): string { return "Logo1.png" }
